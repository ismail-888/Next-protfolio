...
export const starIcons = [
  <StarFillIcon key="starFill" />,
  <StarHalfLineIcon key="starHalf" />,
];

export const arrowIcons = [
  <ArrowLeftSLineIcon key="arrowLeft" />,
  <ArrowRightSLineIcon key="arrowRight" />,
];
